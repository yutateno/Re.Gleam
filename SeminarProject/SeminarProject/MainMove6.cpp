...
void MainMove6::BattleTextureReload()
{
	...
	case ETextureColor::D_CORRECTION:
		...
		LoadFile::MyLoad("media\\UI\\gage\\D.pyn", battleHealDraw[2], ELOADFILE::graph);
		LoadFile::MyLoad("media\\UI\\gageIn\\D.pyn", battleHealDraw[3], ELOADFILE::graph);
	...
	case ETextureColor::P_CORRECTION:
		...
		LoadFile::MyLoad("media\\UI\\gage\\P.pyn", battleHealDraw[2], ELOADFILE::graph);
		LoadFile::MyLoad("media\\UI\\gageIn\\P.pyn", battleHealDraw[3], ELOADFILE::graph);
