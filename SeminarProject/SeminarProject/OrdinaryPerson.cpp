...
void OrdinaryPerson::TextureReload()
{
	...
	case ETextureColor::NORMAL:
		LoadFile::MyLoad("media\\move4\\一般人＿その１\\human1_motionALL.fbm\\normal\\human_col.pyn", textureHandle0, ELOADFILE::graph);
		break;

	case ETextureColor::D_CORRECTION:
		LoadFile::MyLoad("media\\move4\\一般人＿その１\\human1_motionALL.fbm\\D\\human_col.pyn", textureHandle0, ELOADFILE::graph);
		break;

	case ETextureColor::P_CORRECTION:
		LoadFile::MyLoad("media\\move4\\一般人＿その１\\human1_motionALL.fbm\\P\\human_col.pyn", textureHandle0, ELOADFILE::graph);
		break;
